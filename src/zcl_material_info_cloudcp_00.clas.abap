CLASS zcl_material_info_cloudcp_00 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_material_info_cloudcp_00 IMPLEMENTATION.
  ...
  METHOD if_oo_adt_classrun~main.
    DATA material_info TYPE REF TO zcl_material_info_cloudcp_00.
    material_info = NEW zcl_material_info_cloudcp_00(  ).
